...
class Email {
    ...
    public function sendAppointmentDetails(
        ...
        $replaceArray = [
            ...
            '$appointment_start_date' => new \DateTime($appointment['start_datetime']),
            '$appointment_end_date' => new \DateTime($appointment['end_datetime']),
    ...
    public function sendDeleteAppointment(
        ...
        $replaceArray = [
            ...
            '$appointment_service' => $service['name'],
            '$appointment_provider' => $provider['first_name'] . ' ' . $provider['last_name'],
            '$appointment_date' => new \DateTime($appointment['start_datetime']),
