...
class Email {
    ...
    public function sendAppointmentDetails(
        ...
        $replaceArray = [
            ...
            '$appointment_start_date' => date($date_format . ' ' . $timeFormat, strtotime($appointment['start_datetime'])) . ' UTC +00:00',
            '$appointment_end_date' => date($date_format . ' ' . $timeFormat, strtotime($appointment['end_datetime'])) . ' UTC +00:00',
    ...
    public function sendDeleteAppointment(
        ...
        $replaceArray = [
            ...
            '$appointment_service' => $service['name'],
            '$appointment_provider' => $provider['first_name'] . ' ' . $provider['last_name'],
            '$appointment_date' => date($date_format . ' ' . $timeFormat, strtotime($appointment['start_datetime'])) . ' UTC +00:00',
